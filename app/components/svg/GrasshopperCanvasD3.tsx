...
import { renderGrasshopperGraph } from "@/lib/grasshopper-renderer/renderGrasshopperGraph";
import * as d3 from "d3";
import { Fullscreen, Save, ScanSearch } from "lucide-react";
...
const GrasshopperCanvasD3: React.FC<GHProps> = ({
    nodes,
    connectors,
    canvasWidth,
    canvasHeight
  ...
  // Render Graph
    useEffect(() => {
        ...
        defs.select("#grid")
            .append("path")
            .attr("d", "M 300 0 L 0 0 0 100")
            .attr("fill", "none")
            .attr("stroke", "rgba(101,101,101,0.7)")
        ...
        const container = renderGrasshopperGraph({
            svg,
            nodes,
            connectors,
        });
...
export default GrasshopperCanvasD3;