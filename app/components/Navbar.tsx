...
export function Navbar() {
    ...
    return (
    <nav className= {`sticky top-0 left-0 z-20 ${!top && `bg-white shadow-lg dark:bg-black`} max-w-7xl mx-auto px-4 md:px-8 py-2 grid grid-cols-12`}>
        <div className="col-span-6 flex md:col-span-3">
            <Link href="/">                
                <h1 className="text-4xl font-bold text-blue-950 dark:text-white">
                    BIM<span className="text-blue-400 font-bold italic text-2xl">formative</span>
                </h1>
            </Link>
        </div>
