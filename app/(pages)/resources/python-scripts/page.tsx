...
export default async function PythonPage() {
    ...
    return (
        <section className="mx-auto w-full max-w-7xl px-4 md:px-8 min-h-[900px]">
            <PageBanner title="Python Scripts" description="Crafted to automate tasks, enhance workflows, and unlock new possibilities." variant="python" />
